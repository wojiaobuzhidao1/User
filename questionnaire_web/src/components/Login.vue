<template>
  <div>
    <el-row type="flex" justify="end" align="middle" style="margin:0px" height="470px"></el-row>
    <el-row type="flex" justify="center" align="middle" style="margin: 200px">
      <el-col :span="4">
        ...
        <el-row type="flex" justify="center" align="middle" class="markSetRow">
          <el-col :span="18">
            <el-button type="primary" style="width:150px ; background: #1874CD;" @click="login">登录</el-button>
          </el-col>
        </el-row>
        <el-row type="flex" justify="center" align="middle" class="markSetRow">
          <el-col :span="18">
            <el-button type="primary" style="width:150px ; background: #1874CD;" @click="test">测试</el-button>
          </el-col>
        </el-row>
      </el-col>
    </el-row>
